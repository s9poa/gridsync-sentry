...
const CACHE_KEY = 'newReleasesCache';
...
function NewReleases() {
  ...
  return (
    <main className={`${styles.main} wrapper`}>
      <h1><Link to="/" aria-label="Go back to home page" className={styles.homeLink}><i className="fa-solid fa-chevron-left" aria-hidden="true"></i></Link>New Releases</h1>
